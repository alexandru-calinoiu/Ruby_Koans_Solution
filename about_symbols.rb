...
class AboutSymbols < EdgeCase::Koan
  ...
  # against the string value rather than against symbols?            71

  # We have to test the existence of the symbol without actually creating one7

  in_ruby_version("mri") do
    RubyConstant = "What is the sound of one hand clapping?"
    def test_constants_become_symbols
      all_symbols_strings = Symbol.all_symbols.map { |s| s.to_s }

      assert_equal true, all_symbols_strings.include?("RubyConstant")
    end
  end
